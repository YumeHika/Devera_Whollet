                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      gradient: LinearGradient(
                          ...
                          colors: [Color(0xFFEDF1F9), Color(0xFFEDF1F9),Color(0xFFEDF1F9),Color(0xFFEDF1F9)])),
                    child: Stack(children:[
                      ...
                      Container(padding:EdgeInsets.only(right:10),alignment:Alignment.topRight,child:IconButton(onPressed: (){_getBalance();},icon:Icon(Icons.refresh_outlined,size:30,color:Colors.black)))
                    ]),
                  ),
                ),
                Padding(
                                ...
                                child: Row(children: [
                                  ...
                                  Container(
                                      child: IconButton(
                                          ...
                                          onPressed: () {
                                            Clipboard.setData(
                                                ClipboardData(text: "${widget._privateKey}"));
                                            final snackBar = SnackBar(
                                                content:
